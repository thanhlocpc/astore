...
<head>
    ...
    <title>ASTORE | Watch</title>
    <link rel="icon" href="view/client/assets/images/watch/w1.png" type="image/x-icon" />
...
<body>
   ...
   <div class="slide ">
       <div class="small-container">
           <div class="row slide-iphone">
               <a href=""> <img src="view/client/assets/images/slide/slidewatch.png"></a>
           </div>
       </div>
   </div>
    <!-- All Products -->
    ...
    <div class="small-container">
        <div class="row row-2">
            <div class="product-titles">
                ...
                <a href="">
                    <h4 class="white product-titles">Apple Watch Series 7</h4>
                </a>
                <a href="">
                    <h4 class="white product-titles">Apple Watch SE</h4>
                </a>
                <a href="">
                    <h4 class="white product-titles">Apple Watch Series 6</h4>
                </a>
            </div>
   ...
   <jsp:include page="footer/footer.jsp" flush="true"/>
    <script src="view/client/assets/js/products-watch.js"></script>
</body>
